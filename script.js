...
const perguntas = [
    {
        enunciado: "As células-tronco são células com capacidade de autorrenovação e de diferenciação em diversas categorias funcionais de células. Ou seja, as células-tronco têm capacidade de se dividir e se transformar em outros tipos de células. Elas podem ser programadas para desenvolver funções específicas, uma vez que se encontram em um estágio em que ainda não estão totalmente especializadas. O que você acha dessa forma de tratamento?",
        alternativas: [
            {
                texto: "Isso é assustador!",
                afirmacao: "No início, ficou em dúvida sobre a ética relacionada a esse estilo  de procedimento. "
            },
            {
                texto: "Isso é interessante!",
                afirmacao: "Quis saber como funciona esse método de terapia."
            }
        ]
    },
    {
        enunciado: "Você foi convidada para um projeto, que visa conhecimento em uma clínica que aborda esse método de terapia que envolve células-tronco. Qual sua reação? ",
        alternativas: [
            {
                texto: "Você não se sentiu à vontade ao ser convidado, pois sente dúvidas em relação ao método.",
